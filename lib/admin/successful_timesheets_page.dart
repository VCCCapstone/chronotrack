...
class SuccessfulTimesheetsPage extends StatefulWidget {
  const SuccessfulTimesheetsPage({super.key});

  @override
  State<SuccessfulTimesheetsPage> createState() =>
      _SuccessfulTimesheetsPageState();
}

class _SuccessfulTimesheetsPageState extends State<SuccessfulTimesheetsPage> {
  ...
  Future<void> fetchTimesheets() async {
    ...
    const url =
        'https://0lypmz70il.execute-api.ca-central-1.amazonaws.com/prod/timesheets/successful';
    try {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Successful Timesheets"),
        actions: [
          IconButton(
